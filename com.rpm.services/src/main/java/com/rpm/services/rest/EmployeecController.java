...
public class EmployeecController {
	 ...
	 @Autowired
	    ...
	    public Collection<Employee> getAllByDynamicQuery(@PathVariable(value= "key") String key, @PathVariable(value= "value") String value, @PathVariable(value= "operator") String operator) {
	        logger.debug("Getting all employees.");
